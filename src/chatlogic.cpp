...
{
    //// STUDENT CODE
    //// creates Segmentation fault after Task 5 
...
{
    //// STUDENT CODE
    //// Smart pointers take care of memory management now 
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
        ...
        while (getline(file, lineStr))
        {
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    {
                        //// STUDENT CODE
                        //// Task 4 create Edges and move them into the nodes 
    ...
    //Task 5 create local chatbot to be moved around
